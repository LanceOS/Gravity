...
import { PROJECT_STATUS_LABELS, WorkspaceHeader } from '../../workspaces';
...
export function WorkspaceProjectsListPage() {
  ...
  return (
    <div className="workspace-projects-list-page">
      <WorkspaceHeader>
        <WorkspaceHeader.Top>
          <WorkspaceHeader.Title>Workspace Projects</WorkspaceHeader.Title>
      ...
      <div className="workspace-projects-list-page__shell">
        ...
        <div className="workspace-projects-list-page__table">
