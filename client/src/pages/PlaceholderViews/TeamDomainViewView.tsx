...
export default function TeamDomainViewView() {
  ...
  return (
    <PlaceholderLayout
      breadcrumbs={[{ label: 'Teams' }, { label: teamId || 'Team' }, { label: 'Domains' }, { label: domainId || 'Domain' }]}
      title={`Domain Filtered: ${domainId}`}
      description={`Task tickets within domain ${domainId} assigned to team ${teamId}.`}
      params={params}
      degradation={{
        message: 'This workspace does not currently use team domains. Falling back to workspace all tasks.',
    ...
    >
      <div className="placeholder-table-wrapper">
        <div style={{ padding: '20px 24px', borderBottom: '1px solid rgba(255, 255, 255, 0.06)' }}>
          <h3 style={{ fontSize: '15px', color: '#fff' }}>Domain Tickets</h3>
        </div>
        ...
        <div className="placeholder-table-row">
          ...
          <div>Add domain validation layers in auth</div>
          <div>{domainId}</div>
